...
file](https://jcenter.bintray.com/pro/streem/pbandk/protoc-gen-kotlin-jvm/0.10.0-beta.3/:protoc-gen-kotlin-jvm-0.10.0-beta.3-jvm8.jar),
...
dependencies {
    ...
    implementation("pro.streem.pbandk:pbandk-runtime:0.10.0-beta.3")
}
```
...
```
dependencies {
    compileOnly("pro.streem.pbandk:protoc-gen-kotlin-lib:0.10.0-beta.3")
}
```
