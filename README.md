...
file](https://jcenter.bintray.com/pro/streem/pbandk/protoc-gen-kotlin-jvm/0.9.0/:protoc-gen-kotlin-jvm-0.9.0-jvm8.jar),
...
dependencies {
    ...
    implementation("pro.streem.pbandk:pbandk-runtime-common:0.9.0")
    ...
    implementation("pro.streem.pbandk:pbandk-runtime-js:0.9.0")

    // For Kotlin/Native sourcesets/projects:
    implementation("pro.streem.pbandk:pbandk-runtime-native:0.9.0")
}
```
...
```
dependencies {
    compileOnly("pro.streem.pbandk:protoc-gen-kotlin-lib-jvm:0.9.0")
}
```
