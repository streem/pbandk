...
* Android now uses `protobuf-javalite` (instead of `protobuf-java`) to avoid depenency conflicts with other Android libraries such as `com.google.firebase:firebase-perf`. (PR [#124], fixes [#91]) (thanks @jeroenmols)
