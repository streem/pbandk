...
public fun Api(builderAction: pbandk.wkt.MutableApi.() -> Unit): pbandk.wkt.Api =
    pbandk.wkt.MutableApi_Impl(
        name = "",
        methods = pbandk.gen.MutableListField(pbandk.wkt.Api.FieldDescriptors.methods),
        options = pbandk.gen.MutableListField(pbandk.wkt.Api.FieldDescriptors.options),
        version = "",
        sourceContext = null,
        mixins = pbandk.gen.MutableListField(pbandk.wkt.Api.FieldDescriptors.mixins),
...
public fun Method(builderAction: pbandk.wkt.MutableMethod.() -> Unit): pbandk.wkt.Method =
    pbandk.wkt.MutableMethod_Impl(
        ...
        options = pbandk.gen.MutableListField(pbandk.wkt.Method.FieldDescriptors.options),
        syntax = pbandk.wkt.Syntax.fromValue(0),
