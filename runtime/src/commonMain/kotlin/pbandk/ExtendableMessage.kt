...
public interface ExtendableMessage<M : Message> : Message {
    ...
    public fun <T : Any> getRepeatedExtension(fd: FieldDescriptor<M, List<T>>): List<T>
}

public interface MutableExtendableMessage<M : Message> : MutableMessage<M>, ExtendableMessage<M> {
    override fun <T : Any> getRepeatedExtension(fd: FieldDescriptor<M, List<T>>): MutableList<T>
