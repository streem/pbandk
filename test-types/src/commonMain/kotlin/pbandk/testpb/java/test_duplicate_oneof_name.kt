...
public data class Value(
    ...
    override operator fun plus(other: pbandk.Message?): pbandk.testpb.java.Value = protoMergeImpl(other)
    override val descriptor: pbandk.MessageDescriptor<pbandk.testpb.java.Value> get() = Companion.descriptor
    override val protoSize: Int by lazy { super.protoSize }
    public companion object : pbandk.Message.Companion<pbandk.testpb.java.Value> {
        public val defaultInstance: pbandk.testpb.java.Value by lazy { pbandk.testpb.java.Value() }
        override fun decodeWith(u: pbandk.MessageDecoder): pbandk.testpb.java.Value = pbandk.testpb.java.Value.decodeWithImpl(u)

        override val descriptor: pbandk.MessageDescriptor<pbandk.testpb.java.Value> by lazy {
            val fieldsList = ArrayList<pbandk.FieldDescriptor<pbandk.testpb.java.Value, *>>(3)
            fieldsList.apply {
                add(
                    pbandk.FieldDescriptor(
                        ...
                        value = pbandk.testpb.java.Value::stringValue
                    )
                )
                add(
                    pbandk.FieldDescriptor(
                        ...
                        value = pbandk.testpb.java.Value::booleanValue
                    )
                )
                add(
                    pbandk.FieldDescriptor(
                        ...
                        value = pbandk.testpb.java.Value::integerValue
                    )
                )
            }
            pbandk.MessageDescriptor(
                fullName = "testpb.Value",
                messageClass = pbandk.testpb.java.Value::class,
...
public fun Value?.orDefault(): pbandk.testpb.java.Value = this ?: Value.defaultInstance
