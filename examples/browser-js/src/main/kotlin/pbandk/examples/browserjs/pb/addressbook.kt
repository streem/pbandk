package pbandk.examples.browserjs.pb

data class Person(
    val name: String = "",
    val id: Int = 0,
    val email: String = "",
    val phones: List<pbandk.examples.browserjs.pb.Person.PhoneNumber> = emptyList(),
    ...
    data class PhoneNumber(
        val number: String = "",
        val type: pbandk.examples.browserjs.pb.Person.PhoneType = pbandk.examples.browserjs.pb.Person.PhoneType.fromValue(0),
        val unknownFields: Map<Int, pbandk.UnknownField> = emptyMap()
...
data class AddressBook(
    val people: List<pbandk.examples.browserjs.pb.Person> = emptyList(),
    val unknownFields: Map<Int, pbandk.UnknownField> = emptyMap()
...
private fun Person.Companion.protoUnmarshalImpl(protoUnmarshal: pbandk.Unmarshaller): Person {
    ...
    var id = 0
    var email = ""
    var phones: pbandk.ListWithSize.Builder<pbandk.examples.browserjs.pb.Person.PhoneNumber>? = null
    ...
    while (true) when (protoUnmarshal.readTag()) {
        ...
        34 -> phones = protoUnmarshal.readRepeatedMessage(phones, pbandk.examples.browserjs.pb.Person.PhoneNumber.Companion, true)
...
private fun Person.PhoneNumber.Companion.protoUnmarshalImpl(protoUnmarshal: pbandk.Unmarshaller): Person.PhoneNumber {
    var number = ""
    var type: pbandk.examples.browserjs.pb.Person.PhoneType = pbandk.examples.browserjs.pb.Person.PhoneType.fromValue(0)
    while (true) when (protoUnmarshal.readTag()) {
        0 -> return Person.PhoneNumber(number, type, protoUnmarshal.unknownFields())
        10 -> number = protoUnmarshal.readString()
        16 -> type = protoUnmarshal.readEnum(pbandk.examples.browserjs.pb.Person.PhoneType.Companion)
        else -> protoUnmarshal.unknownField()
    }
}
...
private fun AddressBook.Companion.protoUnmarshalImpl(protoUnmarshal: pbandk.Unmarshaller): AddressBook {
    var people: pbandk.ListWithSize.Builder<pbandk.examples.browserjs.pb.Person>? = null
    while (true) when (protoUnmarshal.readTag()) {
        0 -> return AddressBook(pbandk.ListWithSize.Builder.fixed(people), protoUnmarshal.unknownFields())
        10 -> people = protoUnmarshal.readRepeatedMessage(people, pbandk.examples.browserjs.pb.Person.Companion, true)
        else -> protoUnmarshal.unknownField()
    }
}
