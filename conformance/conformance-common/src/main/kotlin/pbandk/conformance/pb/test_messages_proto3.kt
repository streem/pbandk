...
private fun TestAllTypesProto3.Companion.protoUnmarshalImpl(protoUnmarshal: pbandk.Unmarshaller): TestAllTypesProto3 {
    ...
    while (true) when (protoUnmarshal.readTag()) {
        ...
        354 -> repeatedString = protoUnmarshal.readRepeated(repeatedString, protoUnmarshal::readString, false)
        362 -> repeatedBytes = protoUnmarshal.readRepeated(repeatedBytes, protoUnmarshal::readBytes, false)
        386 -> repeatedNestedMessage = protoUnmarshal.readRepeatedMessage(repeatedNestedMessage, pbandk.conformance.pb.TestAllTypesProto3.NestedMessage.Companion, false)
        394 -> repeatedForeignMessage = protoUnmarshal.readRepeatedMessage(repeatedForeignMessage, pbandk.conformance.pb.ForeignMessage.Companion, false)
        410, 408 -> repeatedNestedEnum = protoUnmarshal.readRepeatedEnum(repeatedNestedEnum, pbandk.conformance.pb.TestAllTypesProto3.NestedEnum.Companion)
        418, 416 -> repeatedForeignEnum = protoUnmarshal.readRepeatedEnum(repeatedForeignEnum, pbandk.conformance.pb.ForeignEnum.Companion)
        434 -> repeatedStringPiece = protoUnmarshal.readRepeated(repeatedStringPiece, protoUnmarshal::readString, false)
        442 -> repeatedCord = protoUnmarshal.readRepeated(repeatedCord, protoUnmarshal::readString, false)
        450 -> mapInt32Int32 = protoUnmarshal.readMap(mapInt32Int32, pbandk.conformance.pb.TestAllTypesProto3.MapInt32Int32Entry.Companion, false)
        458 -> mapInt64Int64 = protoUnmarshal.readMap(mapInt64Int64, pbandk.conformance.pb.TestAllTypesProto3.MapInt64Int64Entry.Companion, false)
        466 -> mapUint32Uint32 = protoUnmarshal.readMap(mapUint32Uint32, pbandk.conformance.pb.TestAllTypesProto3.MapUint32Uint32Entry.Companion, false)
        474 -> mapUint64Uint64 = protoUnmarshal.readMap(mapUint64Uint64, pbandk.conformance.pb.TestAllTypesProto3.MapUint64Uint64Entry.Companion, false)
        482 -> mapSint32Sint32 = protoUnmarshal.readMap(mapSint32Sint32, pbandk.conformance.pb.TestAllTypesProto3.MapSint32Sint32Entry.Companion, false)
        490 -> mapSint64Sint64 = protoUnmarshal.readMap(mapSint64Sint64, pbandk.conformance.pb.TestAllTypesProto3.MapSint64Sint64Entry.Companion, false)
        498 -> mapFixed32Fixed32 = protoUnmarshal.readMap(mapFixed32Fixed32, pbandk.conformance.pb.TestAllTypesProto3.MapFixed32Fixed32Entry.Companion, false)
        506 -> mapFixed64Fixed64 = protoUnmarshal.readMap(mapFixed64Fixed64, pbandk.conformance.pb.TestAllTypesProto3.MapFixed64Fixed64Entry.Companion, false)
        514 -> mapSfixed32Sfixed32 = protoUnmarshal.readMap(mapSfixed32Sfixed32, pbandk.conformance.pb.TestAllTypesProto3.MapSfixed32Sfixed32Entry.Companion, false)
        522 -> mapSfixed64Sfixed64 = protoUnmarshal.readMap(mapSfixed64Sfixed64, pbandk.conformance.pb.TestAllTypesProto3.MapSfixed64Sfixed64Entry.Companion, false)
        530 -> mapInt32Float = protoUnmarshal.readMap(mapInt32Float, pbandk.conformance.pb.TestAllTypesProto3.MapInt32FloatEntry.Companion, false)
        538 -> mapInt32Double = protoUnmarshal.readMap(mapInt32Double, pbandk.conformance.pb.TestAllTypesProto3.MapInt32DoubleEntry.Companion, false)
        546 -> mapBoolBool = protoUnmarshal.readMap(mapBoolBool, pbandk.conformance.pb.TestAllTypesProto3.MapBoolBoolEntry.Companion, false)
        554 -> mapStringString = protoUnmarshal.readMap(mapStringString, pbandk.conformance.pb.TestAllTypesProto3.MapStringStringEntry.Companion, false)
        562 -> mapStringBytes = protoUnmarshal.readMap(mapStringBytes, pbandk.conformance.pb.TestAllTypesProto3.MapStringBytesEntry.Companion, false)
        570 -> mapStringNestedMessage = protoUnmarshal.readMap(mapStringNestedMessage, pbandk.conformance.pb.TestAllTypesProto3.MapStringNestedMessageEntry.Companion, false)
        578 -> mapStringForeignMessage = protoUnmarshal.readMap(mapStringForeignMessage, pbandk.conformance.pb.TestAllTypesProto3.MapStringForeignMessageEntry.Companion, false)
        586 -> mapStringNestedEnum = protoUnmarshal.readMap(mapStringNestedEnum, pbandk.conformance.pb.TestAllTypesProto3.MapStringNestedEnumEntry.Companion, false)
        594 -> mapStringForeignEnum = protoUnmarshal.readMap(mapStringForeignEnum, pbandk.conformance.pb.TestAllTypesProto3.MapStringForeignEnumEntry.Companion, false)
        ...
        1690 -> repeatedBoolWrapper = protoUnmarshal.readRepeatedMessage(repeatedBoolWrapper, pbandk.wkt.BoolValue.Companion, false)
        1698 -> repeatedInt32Wrapper = protoUnmarshal.readRepeatedMessage(repeatedInt32Wrapper, pbandk.wkt.Int32Value.Companion, false)
        1706 -> repeatedInt64Wrapper = protoUnmarshal.readRepeatedMessage(repeatedInt64Wrapper, pbandk.wkt.Int64Value.Companion, false)
        1714 -> repeatedUint32Wrapper = protoUnmarshal.readRepeatedMessage(repeatedUint32Wrapper, pbandk.wkt.UInt32Value.Companion, false)
        1722 -> repeatedUint64Wrapper = protoUnmarshal.readRepeatedMessage(repeatedUint64Wrapper, pbandk.wkt.UInt64Value.Companion, false)
        1730 -> repeatedFloatWrapper = protoUnmarshal.readRepeatedMessage(repeatedFloatWrapper, pbandk.wkt.FloatValue.Companion, false)
        1738 -> repeatedDoubleWrapper = protoUnmarshal.readRepeatedMessage(repeatedDoubleWrapper, pbandk.wkt.DoubleValue.Companion, false)
        1746 -> repeatedStringWrapper = protoUnmarshal.readRepeatedMessage(repeatedStringWrapper, pbandk.wkt.StringValue.Companion, false)
        1754 -> repeatedBytesWrapper = protoUnmarshal.readRepeatedMessage(repeatedBytesWrapper, pbandk.wkt.BytesValue.Companion, false)
        ...
        2490 -> repeatedDuration = protoUnmarshal.readRepeatedMessage(repeatedDuration, pbandk.wkt.Duration.Companion, false)
        2498 -> repeatedTimestamp = protoUnmarshal.readRepeatedMessage(repeatedTimestamp, pbandk.wkt.Timestamp.Companion, false)
        2506 -> repeatedFieldmask = protoUnmarshal.readRepeatedMessage(repeatedFieldmask, pbandk.wkt.FieldMask.Companion, false)
        2522 -> repeatedAny = protoUnmarshal.readRepeatedMessage(repeatedAny, pbandk.wkt.Any.Companion, false)
        2530 -> repeatedValue = protoUnmarshal.readRepeatedMessage(repeatedValue, pbandk.wkt.Value.Companion, false)
        2594 -> repeatedStruct = protoUnmarshal.readRepeatedMessage(repeatedStruct, pbandk.wkt.Struct.Companion, false)
